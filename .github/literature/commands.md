        ...
        argument<String>("type") { type ->
            ...
            argument<String>("text", StringArgumentType.greedyString()) { text ->
                runs {
                    ...
                    source.playerOrException.sendNotifcation(
                        literalText(text.invoke(this)),
                        item.invoke(this).createItemStack(1, false),
                        remappedType
                    )
                }
            }
        ...
        runs {
            mcCoroutineScope.launch {
                Advancements.awardAdvancement(
                    ...
                    Advancements.advancement(ResourceLocation.parse(advancement.invoke(this@runs)))!!
                )
            }
        }
    }
