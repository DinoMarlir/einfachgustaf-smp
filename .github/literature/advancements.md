...
val claim = Advancements.register(
    GustafAdvancement(
        Items.WHITE_BANNER.defaultInstance,
        literalText("Settler!"),
        literalText("Claim a chunk!"),
        AdvancementType.TASK,
        unlocks = setOf(Advancements.res("welcome/claim16")),
        rewards = setOf(Items.BOW.defaultInstance)
    ),
    "welcome/claim",
    welcome,
    x = 3f,
...
val claim16 = Advancements.register(
    GustafAdvancement(
        Items.PINK_BANNER.defaultInstance,
        literalText("My Empire!"),
        literalText("Claim at least 16 chunks"),
...
val hello = Advancements.register(
    GustafAdvancement(
        Items.OAK_BOAT.defaultInstance,
        literalText("Hello!"),
        literalText("Introduce yourself in the chat!"),
